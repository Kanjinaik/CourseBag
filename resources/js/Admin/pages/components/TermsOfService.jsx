...
export default function TermsOfService({ page = null }) {
    ...
    const submit = (e) => {
        ...
        put(`/admin/pages/terms-of-service`, submitData, {
            preserveScroll: true,
            onSuccess: () => {
                router.reload({ 
                    only: ['page'],
        ...
        <AdminLayout title="Terms of Service">
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Manage your Terms of Service page content</p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="p-6">
                        <div className="mb-6 pb-4 border-b border-gray-200">
                            ...
                            <p className="text-sm text-gray-500 mt-1">Edit content for Terms of Service page</p>
                        </div>
