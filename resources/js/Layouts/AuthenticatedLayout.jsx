import ApplicationLogo from '@/User/Components/ApplicationLogo';
import Dropdown from '@/User/Components/Dropdown';
import NavLink from '@/User/Components/NavLink';
import ResponsiveNavLink from '@/User/Components/ResponsiveNavLink';
...
export default function AuthenticatedLayout({ header, children }) {
    ...
    const { websiteSettings } = page.props;
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    ...
                                    active={route().current('mytransections.*')}
                                >
                                    My Transactions
                                </NavLink>
                            </div>
